...
public class Session_Booking extends CommonToAllTest {
        ...
        public void createSession() {
                ...
                WebElement noti_read_accept = driver.findElement(
                                By.xpath("//span[contains(text(),\"Your session request has been submitted\")]"));
                ...
                // Assert.assertEquals(noti_read_accept.getText(),"Your session request has been
                // submitted to Ankit Jain");
                ...
                // WebElement noti_tab =
                // driver.findElement(By.xpath("//a[@href=\"/account/notifications\"]"));
                ...
                WebElement noti_read_cancel = driver
                                .findElement(By.xpath("//span[text()=\"Session cancellation success\"]"));
